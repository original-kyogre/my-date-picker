...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"ucupay-dp-calendar-item month-"
...
var _EasyDate = __webpack_require__(7);
...
var DatePicker = function () {
    ...
    _createClass(DatePicker, [{
        ...
        value: function createElement(options) {
            ...
            var months = [];
            for (var i = 0; i < 2; i++) {
                var month = this.createMonthObject(current, today, start, end);
                months.push(month);
                current.add('+1m');
            }
            ...
            if (options.fixCalendarContainer) {
                this.$el.find('.ucupay-dp-container').height((0, _jquery2.default)(window).height() - 105);
            }
        }
        ...
        value: function delegateEvent(options) {
            ...
            this.$el.on('click', 'li:not(.disable,.empty,.out-range)', this.onClick.bind(this)).on('click', 'ucupay-dp-close-button', function () {
                _this.$el.addClass('out');
            }).on('click', 'ucupay-dp-confirm-button', function () {
                _this.confirm();
        ...
        value: function onScroll(event) {
            ...
            if (container.scrollHeight - container.scrollTop <= container.offsetHeight + 10) {
                var item = (0, _calendar2.default)(this.createMonthObject(this.lastMonth, this.options.today, this.options.start, this.options.end));
                container.appendChild((0, _jquery2.default)(item)[0]);
                this.lastMonth.add('+1m');
                if (this.lastMonth.isGreaterOrEqual(this.options.end)) {
                    (0, _jquery2.default)(container).off('scroll');
                }
                return true;
            }
        }
...
var EasyDate = function () {
    ...
    _createClass(EasyDate, [{
        ...
        value: function isGreaterOrEqual(date) {
            if (!date) {
                return false;
            }
...
window.addEventListener('load', function () {
    ...
    var picker = options.ucupayDatePicker;
    if (picker) {
        picker.show();
    }
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
    ...
    return "            <button type=\"button\" class=\"ucupay-dp-confirm-button\">确定</button>\r\n";
},"9":function(container,depth0,helpers,partials,data) {
    var stack1;

  return ((stack1 = container.invokePartial(__webpack_require__(3),depth0,{"name":"calendar","data":data,"indent":"            ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, alias1=depth0 != null ? depth0 : (container.nullContext || {});

  return "<div class=\"ucupay-date-picker static "
    ...
    + "\">\r\n    <header class=\"ucupay-dp-header\">\r\n        <button type=\"button\" class=\"ucupay-dp-close-button\">&lt;</button>\r\n        <h3>选择时间</h3>\r\n"
    ...
    + "        <ul class=\"ucupay-dp-labels\">\r\n            <li class=\"sunday\">日</li>\r\n            <li class=\"\">一</li>\r\n            <li class=\"\">二</li>\r\n            <li class=\"\">三</li>\r\n            <li class=\"\">四</li>\r\n            <li class=\"\">五</li>\r\n            <li class=\"saturday\">六</li>\r\n        </ul>\r\n    </header>\r\n    <div class=\"ucupay-dp-container\">\r\n"
...
/***/ })
/******/ ]);
//# sourceMappingURL=ucupay-date-picker.bundle.js.map